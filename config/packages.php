...
return array(
    'jquery' => array(
        ...
        'baseUrl' => 'http://cdn.bootcss.com/jquery/2.1.4',
    ),
    'yii' => array(
        'js' => array('jquery.yii.js'),
        'depends' => array('jquery'),
        'baseUrl' => 'http://taxi7.toruneko.net/assets/js',
    ),
    'yiitab' => array(
        'js' => array('jquery.yiitab.js'),
        'depends' => array('jquery'),
        'baseUrl' => 'http://taxi7.toruneko.net/assets/yiitab',
    ),
    'yiiactiveform' => array(
    ...
    'jquery.ui' => array(
        ...
        'depends' => array('jquery'),
        'baseUrl' => 'http://taxi7.toruneko.net/assets/jui/js',
    ),
    'bgiframe' => array(
    ...
    'autocomplete' => array(
        ...
        'baseUrl' => 'http://taxi7.toruneko.net/assets/autocomplete',
    ),
    'maskedinput' => array(
    ...
    'treeview' => array(
        ...
        'baseUrl' => 'http://taxi7.toruneko.net/assets/treeview',
    ),
    'multifile' => array(
    ...
    'rating' => array(
        ...
        'baseUrl' => 'http://taxi7.toruneko.net/assets/rating',
    ),
    'metadata' => array(
    ...
    'bootstrap' => array(
        ...
        'depends' => array('jquery'),
        'baseUrl' => 'http://cdn.bootcss.com/bootstrap/3.3.4',
    ),
    'ztree' => array(
        'js' => array('js/jquery.ztree.all-3.5.min.js'),
        'css' => array('css/zTreeStyle/zTreeStyle.css'),
        'baseUrl' => 'http://taxi7.toruneko.net/assets/zTree_v3',
    ),
    'kindeditor' => array(
        'js' => array('kindeditor-min.js', 'lang/zh_CN.js'),
        'css' => array('themes/default/default.css'),
        'baseUrl' => 'http://taxi7.toruneko.net/assets/kindeditor-4.1.10'
    ),
    'facebox' => array(
        'js' => array('facebox.js'),
        'css' => array('facebox.css'),
        'depends' => array('jquery'),
        'baseUrl' => 'http://taxi7.toruneko.net/assets/facebox'
    ),
    'admin' => array(
        'js' => array('jquery.admin.js'),
        'css' => array('admin.css'),
        'depends' => array('jquery'),
        'baseUrl' => 'http://taxi7.toruneko.net/assets/admin',
    ),
    'prettify' => array(
    ...
    'sunburst' => array(
        ...
        'baseUrl' => 'http://taxi7.toruneko.net/assets/main',
    ),
    'moment' => array(
    ...
    'datetimepicker' => array(
        ...
        'baseUrl' => 'http://taxi7.toruneko.net/assets/datetimepicker',
    ),
    /*'datetimepicker'=>array(
