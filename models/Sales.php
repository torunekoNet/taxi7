 ...
 */
class Sales extends RedActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('cargo_id, cargo_name, amount, price, to, gmt_create, gmt_year, gmt_month, gmt_day, operator', 'required'),
            array('cargo_id, amount, price, gmt_create', 'length', 'max' => 10),
            array('cargo_name, to, operator', 'length', 'max' => 255),
            array('gmt_year', 'length', 'max' => 4),
            array('gmt_month, gmt_day', 'length', 'max' => 2),
            array('comment', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, cargo_id, cargo_name, amount, price, to, gmt_create, gmt_year, gmt_month, gmt_day, comment, operator', 'safe', 'on' => 'search'),
        );
    }
